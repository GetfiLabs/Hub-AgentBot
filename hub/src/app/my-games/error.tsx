  ...
  return (
    <div className="app-shell grid min-h-[62vh] place-items-center py-12 text-center">
      <div className="panel max-w-md p-8">
        ...
        <h1 className="mt-5 text-2xl font-black text-heading">Oyunlar failed to load</h1>
        <p className="mt-2 text-[var(--muted)]">Game data failed to load. Please try again.</p>
        {error.digest && (
