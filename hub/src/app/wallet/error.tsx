  ...
  return (
    <div className="app-shell grid min-h-[62vh] place-items-center py-12 text-center">
      <div className="panel max-w-md p-8">
        ...
        <h1 className="mt-5 text-2xl font-black text-heading">Wallet failed to load</h1>
        <p className="mt-2 text-[var(--muted)]">Wallet data failed to load. Please try again.</p>
        {error.digest && (
          <p className="mt-3 font-mono text-xs text-[var(--muted)]">Hata kodu: {error.digest}</p>
        )}
